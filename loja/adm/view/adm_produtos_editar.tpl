...
<section class="row" id="camposproduto">
    ...
    <form name="frm_produto" method="post" action="" enctype="multipart/form-data">
        ...
        <div class="col-md-6"> 
            <label>Produto</label>
            <input type="text" name="pro_nome" id="pro_nome" class="form-control"  placeholder="Produto" required value="{$PRO.1.pro_nome}">
        </div>
        ...
        <div class="col-md-2"> 
            <label>Ativo</label>
            <select name="pro_ativo" id="pro_ativo" class="form-control" required value="{$PRO.1.pro_ativo}" >
        ...
        <div class="col-md-3">  
            <label>Modelo</label>
            <input type="text" name="pro_modelo" id="pro_modelo" class="form-control"  placeholder="Modelo" value="{$PRO.1.pro_modelo}" >
        </div>

        <div class="col-md-2"> 
            <label>Referência</label>
            <input type="text" name="pro_ref" id="pro_ref" class="form-control"  placeholder="Referência" value="{$PRO.1.pro_ref}" >
        </div>

        <div class="col-md-2"> 
            <label>Valor</label>
            <input type="text" name="pro_valor" id="pro_valor" class="form-control"  placeholder="Valor" required value="{$PRO.1.pro_valor}">
        </div>

        <div class="col-md-2"> 
            <label>Estoque</label>
            <input type="text" name="pro_estoque" id="pro_estoque" class="form-control" value="{$PRO.1.pro_estoque}">
        </div>

        <div class="col-md-2"> 
            <label>Peso</label>
            <input type="text" name="pro_peso" id="pro_peso" class="form-control"  placeholder="Peso" required value="{$PRO.1.pro_peso}">
        </div>

        <div class="col-md-2"> 
            <label>Altura</label>
            <input type="text" name="pro_altura" id="pro_altura" class="form-control"  placeholder="Altura" required value="{$PRO.1.pro_altura}">
        </div>

        <div class="col-md-2"> 
            <label>Largura</label>
            <input type="text" name="pro_largura" id="pro_largura" class="form-control"  placeholder="Largura" required value="{$PRO.1.pro_largura}">
        </div>

        <div class="col-md-2"> 
            <label>Comprimento</label>
            <input type="text" name="pro_comprimento" id="pro_comprimento" class="form-control"  placeholder="Comprimento" required value="{$PRO.1.pro_comprimento}">
        </div>
        ...
        <div class="col-md-12"> 
            <div class="col-md-3">
                <hr>
                <img src="{$PRO.1.pro_img}" class="thumbnail">
            ...
            <div class="col-md-6">
                ...
                {*pega o diretorio da imagem para deleta-la caminho completo*}
       ...
       <!-- E preciso coloca-lo aqui abaixo do text area-->  
        ...
        <div class="col-md-12"> 
            <label>Slug</label>
            <input type="text" name="pro_slug" id="pro_slug" class="form-control" readonly value="{$PRO.1.pro_slug}">
        </div>
        ...
        {*pega o id do produto para ser carregado no post*}
