...
<section class="row" id="cadastro">
        ...
        <div class="col-md-2">
            <label>CPF:</label>
            <input type="text" name="cli_cpf" value="{$CLI_CPF}" class="form-control" minlength="11" maxlength="11" required readonly>
        ...
        <div class="col-md-2">
         ...
         <div class="col-md-4">
            <label>Email:</label>
            <input type="text" name="cli_email" value="{$CLI_EMAIL}" class="form-control" required readonly>
