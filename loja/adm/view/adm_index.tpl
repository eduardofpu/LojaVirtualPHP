        ...
        <div class="container-fluid">
            ...
            <div class="row" id="topo">
                ...
                <div class="container">
                    ...
                    <div class="col-md-6">                
                     <!--<img src="{$GET_TEMA}/images/adm_logo.jpg" alt=""  width="15%"  > -->
                        <label>
                ...
                <div class="container"> 
                    ...
                    <div class="col-md-2" id="lateral">
                        ...
                        <div class="list-group">
                            ...
                            <a href="{$PAG_ADM_PRODUTOS }" class="list-group-item">
                                <span class="glyphicon glyphicon-menu-right"></span>Todos</a> 
                            <!---->
                            {foreach from=$CATEGORIAS item=C}

                                <a href="{$C.cate_link_adm }" class="list-group-item">
