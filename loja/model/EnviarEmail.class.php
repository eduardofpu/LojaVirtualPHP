 ...
 */
class EnviarEmail extends PHPMailer { // Atenção!!! Para funcionar e importante desabilitar o anti virus
    /**
   ...
   */
	...
	parent::IsHTML(true);
        ...
        $this->FromName    = Config::EMAIL_NOME;  // mini loja 2017
        $this->From        = Config::EMAIL_USER; //eduardo27_minotauro@hotmail.com
        $this->Username    = Config::EMAIL_USER; //eduardo27_minotauro@hotmail.com
        $this->Password    = Config::EMAIL_SENHA;//senha do meu email
